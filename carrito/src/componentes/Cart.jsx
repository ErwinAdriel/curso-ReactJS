                    ...
                    {cartItems.map((item, index) => (
                        <li key={index}>
                            <div className="mt-3">
                                ...
                                <input type="text" id="cantidad" value={item.cantidad} data-input-counter aria-describedby="helper-text-explanation" className="border-1 border-gray-300 h-9 text-center text-black text-sm w-12" placeholder="0" required readOnly />
